...
const PersonalInformationPage = () => {
  ...
  async function handleEmergencyContactDelete(emergencyContactEntry) {
    console.log(
      `Delete button clicked to delete emergency contact ${emergencyContactEntry.firstName}:`
    );
    await axios
      .put(
        `http://localhost:4000/api/personalInformation/delete/emergencyContact/${emergencyContactEntry.firstName}`,
        formData
      )
      .then((res) => {
        console.log("Deleted emergency contact information", res.data);
  ...
  async function handleDelete(employmentEntry) {
    console.log(
      `Delete button clicked to delete employment ${employmentEntry.visaTitle}:`
    );
    await axios
      .put(
              ...
              <table className="table-fixed w-full text-left">
                <thead className="text-base uppercase bg-[#dedede]">
                  <tr>
                    ...
                    <th scope="col" className="w-1/12 px-12 py-3"></th>
                  </tr>
                </thead>
                <tbody>
                    ...
                    (emergencyContactEntry, index) => (
                      <tr
                        ...
                        className={`border-b-2 ${
                          emergencyContactEntry.firstName === "" ? "hidden" : ""
                        }`}
                      >
                        <th
                          scope="row"
